...
<li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    ...
    <div class="menu-submenu "><i class="menu-arrow"></i>
        <ul class="menu-subnav">
            ...
            @can('driverWeights view')
            <li class="menu-item  {{ Request::is('*driverWeights*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('adminPanel.driver_weights.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/driverWeights.plural')</span>
                </a>
            </li>
            @endcan
...
@can('sizes view')
<li class="menu-item  {{ Request::is('*sizes*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
    <a href="{{ route('adminPanel.sizes.index') }}" class="menu-link ">
        <span class="svg-icon menu-icon">
            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="menu-text">@lang('models/sizes.plural')</span>
    </a>
</li>
@endcan

@can('states view')
<li class="menu-item  {{ Request::is('*states*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
...
<li class="menu-item  {{ Request::is('*donationTypes*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
...
<li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    ...
    <div class="menu-submenu "><i class="menu-arrow"></i>
        <ul class="menu-subnav">
            ...
            @can('products view')
            <li class="menu-item  {{ Request::is('*products*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('adminPanel.products.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/products.plural')</span>
                </a>
            </li>
            @endcan

            @can('orders view')
            <li class="menu-item  {{ Request::is('*orders*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('adminPanel.orders.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/orders.plural')</span>
                </a>
            </li>
            @endcan
...
<li class="menu-item  {{ Request::is('*donations*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
    <a href="{{ route('adminPanel.donations.index') }}" class="menu-link ">
        <span class="svg-icon menu-icon">
            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="menu-text">@lang('models/donations.plural')</span>
    </a>
</li>
...
{{-- <li class="menu-item  {{ Request::is('adminPanel/productPhotos*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
<a href="{{ route('adminPanel.productPhotos.index') }}" class="menu-link ">
    <span class="svg-icon menu-icon">
        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="menu-text">@lang('models/productPhotos.plural')</span>
</a>
</li> --}}
